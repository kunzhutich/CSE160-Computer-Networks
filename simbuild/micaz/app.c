...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x7f6424899020, const void *arg_0x7f6424899320);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x7f64247ea5e0) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7f6423ee13a0), 
int (*key_eq_fn)(void *arg_0x7f6423ee1b70, void *arg_0x7f6423ee1e30));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7f6423ccec00, int arg_0x7f6423ccee80);
static double RandomUniform(void );
...
#line 85
          {
            ...
            (__nesc_temp43 = myMsg->TTL.nxdata, __nesc_hton_uint8(__nesc_temp43, __nesc_ntoh_uint8(__nesc_temp43) - 1));
            FloodP__fMap__insert(key, 1);
...
#line 55
  ...
  if (__nesc_ntoh_uint8(ndMsg->protocol.nxdata) == PROTOCOL_PING && __nesc_ntoh_uint8(ndMsg->TTL.nxdata) > 0) {
      ...
      (__nesc_temp42 = ndMsg->TTL.nxdata, __nesc_hton_uint8(__nesc_temp42, __nesc_ntoh_uint8(__nesc_temp42) - 1));
...
#line 70
    if (__nesc_ntoh_uint8(ndMsg->protocol.nxdata) == PROTOCOL_PINGREPLY && __nesc_ntoh_uint16(ndMsg->dest.nxdata) == 0) {
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7f64239c1e30, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7f64239c1e30) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7f64239c1e30, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7f64239c0a50, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7f64239c0a50, msg, payload, len);
#line 78
...
# 110 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7f64239dbc70, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7f64239dbc70, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-main/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7f6423384940, message_t * msg, error_t error){
#line 100
  switch (arg_0x7f6423384940) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7f6423384940, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7f6423ba2020){
#line 75
  switch (arg_0x7f6423ba2020) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7f6423ba2020);
#line 75
      break;
#line 75
    }
...
#line 78
# 80 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7f6423383b60, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7f6423383b60, addr, msg, len);
#line 80
...
#line 142
  ...
  NDiscP__makePack(&NDiscP__pck[sim_node()], TOS_NODE_ID, 0, 1, PROTOCOL_PING, totalPacketsSent, &payload, PACKET_MAX_PAYLOAD_SIZE);
...
# 83 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7f6423435950){
#line 83
  switch (arg_0x7f6423435950) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7f6423435950);
#line 83
      break;
#line 83
    }
...
#line 62
  __nesc_result = /*FloodC.SimpleSendC.PoolC.PoolP*/PoolP__3__Init__init();
#line 62
...
#line 99
  ...
  for (i = 0; i < NDiscP__ndMap__size(); i++) {
      if (keys[i] != 0) {
          ...
          sim_log_debug(182U, NEIGHBOR_CHANNEL, "\tNode %d: Link Quality: %.2f, Active: %s, SeqNum: %d\n", keys[i], linkQuality, isActive ? "Yes" : "No", totalPacketsSent);
        }
    }
}
